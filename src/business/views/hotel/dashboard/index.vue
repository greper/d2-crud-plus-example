<template >
  <d2-container class="page">
    ...
    <edit-dialog ref="checkInEditDialog" :columns="crud.columns"
                 ...
                 @dialog-cancel="handleDialogCancel"></edit-dialog>
  </d2-container>
</template>
...
export default {
  ...
  methods: {
    ...
    addCheckIn (item) {
      ...
      this.$refs.checkInEditDialog.handleAdd(this.crud.addTemplate)
    },
    editCheckIn (checkIn) {
      this.$refs.checkInEditDialog.handleEdit(0, checkIn)
    },
    delCheckIn (checkIn) {
      this.$refs.checkInEditDialog.handleRemove(0, checkIn)
    },
    doRefresh () {
      this.loadData()
    }
